...
export function verifyWebContainerContract(inputs: WebContainerInputs): ContractFinding[] {
  ...
  const dockerfileRequirements: Array<[string, string, string]> = [
    ...
    ["npm run build", "WEB_DOCKER_NEXT_BUILD", "Next build missing"],
    ...
    ["COPY scripts/staging-jj-glow-candidate4-runtime-authorize.ts", "WEB_DOCKER_RUNTIME_AUTHORIZER_SOURCE", "runtime authorizer source missing from build"],
    ["esbuild scripts/staging-jj-glow-candidate4-runtime-authorize.ts", "WEB_DOCKER_RUNTIME_AUTHORIZER_BUNDLE", "runtime authorizer bundle step missing"],
    ["/srv/app/scripts/staging-jj-glow-candidate4-runtime-authorize.cjs ./scripts/staging-jj-glow-candidate4-runtime-authorize.cjs", "WEB_DOCKER_RUNTIME_AUTHORIZER_COPY", "runtime authorizer artifact missing"],
    ["test -f /srv/app/scripts/staging-jj-glow-candidate4-runtime-authorize.cjs", "WEB_DOCKER_RUNTIME_AUTHORIZER_ASSERT", "runtime authorizer build assertion missing"],
    ["node --check /srv/app/scripts/staging-jj-glow-candidate4-runtime-authorize.cjs", "WEB_DOCKER_RUNTIME_AUTHORIZER_SYNTAX", "runtime authorizer syntax assertion missing"],
    ["COPY scripts/staging-jj-glow-candidate4-runtime-successor-authorize.ts", "WEB_DOCKER_RUNTIME_SUCCESSOR_AUTHORIZER_SOURCE", "runtime successor authorizer source missing from build"],
    ["esbuild scripts/staging-jj-glow-candidate4-runtime-successor-authorize.ts", "WEB_DOCKER_RUNTIME_SUCCESSOR_AUTHORIZER_BUNDLE", "runtime successor authorizer bundle step missing"],
    ["/srv/app/scripts/staging-jj-glow-candidate4-runtime-successor-authorize.cjs ./scripts/staging-jj-glow-candidate4-runtime-successor-authorize.cjs", "WEB_DOCKER_RUNTIME_SUCCESSOR_AUTHORIZER_COPY", "runtime successor authorizer artifact missing"],
    ["test -f /srv/app/scripts/staging-jj-glow-candidate4-runtime-successor-authorize.cjs", "WEB_DOCKER_RUNTIME_SUCCESSOR_AUTHORIZER_ASSERT", "runtime successor authorizer build assertion missing"],
    ["node --check /srv/app/scripts/staging-jj-glow-candidate4-runtime-successor-authorize.cjs", "WEB_DOCKER_RUNTIME_SUCCESSOR_AUTHORIZER_SYNTAX", "runtime successor authorizer syntax assertion missing"],
