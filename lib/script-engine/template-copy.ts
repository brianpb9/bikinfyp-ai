...
const ADEGAN_ADS: Record<string, AdsScene> = {
  "ads-unboxing-pov": {
    ...
    friction2: ["Kertas pelindung disibak, sih.", "Kartu kemasan muncul, sih.", "Nama pada label mendekat, sih.", "Paketnya diputar, sih."],
    spikes: ["Nah, kemasannya terlihat.", "Nah, kardusnya terbaca.", "Nah, kartunya muncul.", "Nah, paketnya menghadap saksi."],
    questions: ["Sisi kemasan?", "Muka kardus?", "Isi paket?", "Bungkus luar?"],
    saksi: "ibu di samping meja",
  },
  "ads-meja-kosong": {
    hooks: ["Nah, kartu di meja?", "Eh, kenapa lampunya menyala?", "Tulisan apa di kertas itu?", "Bun, siapa menaruh pulpen?"],
    friction1: ["Tiga kartu berjejer.", "Lampu mejanya diarahkan.", "Kertas putih dibuka.", "Pulpen diletakkan."],
    friction2: ["Kartu tengah dibalik, sih.", "Satu nama disorot, sih.", "Tulisan hitam didekatkan, sih.", "Nama layanan ditulis, sih."],
    spikes: ["Nah, kartu meja tampak.", "Nah, tengahnya terbaca.", "Nah, layanannya disorot.", "Nah, tulisan menghadap saksi."],
    questions: ["Bidang meja?", "Sinar desktop?", "Kertas kerja?", "Tinta pulpen?"],
  ...
  "ads-panas-ekstrem": {
    ...
    friction2: ["Kartu produk masuk, sih.", "Nama pada kipas terlihat, sih.", "Label gelas diputar, sih.", "Tulisan putih muncul, sih."],
    spikes: ["Nah, kartu merah tampak.", "Nah, kipasnya terbaca.", "Nah, label menghadap saksi.", "Nah, tulisan disorot."],
  ...
  "ads-tembus-dinding": {
    ...
    friction2: ["Kartu nama menyembul melalui celah karton, sih.", "Tulisan produk muncul perlahan dari panel busa, sih.", "Label produk didekatkan ke arah satpam, sih.", "Satpam mengangkat kartu di bawah lampu, sih."],
    spikes: ["Nah, kartunya terlihat jelas.", "Nah, panelnya menampilkan tulisan.", "Nah, label menghadap satpam.", "Nah, kartu produk disorot."],
  ...
  "ads-atap-jebol": {
    ...
    friction2: ["Kartu nama diturunkan, sih.", "Lampu mengarah ke tulisan, sih.", "Ibu mengangkat label, sih.", "Nama produknya mendekat, sih."],
    spikes: ["Nah, kartu plafon turun.", "Nah, atasnya terbaca.", "Nah, label menghadap ibu.", "Nah, konfeti menyorot produk."],
  ...
  "ads-dobrak-pintu": {
    ...
    friction2: ["Kartu nama didekatkan, sih.", "Tulisan pintunya disorot, sih.", "Petugas mengangkat label, sih.", "Nama produk muncul, sih."],
    spikes: ["Nah, kartu pintu muncul.", "Nah, pintunya terbaca.", "Nah, label menghadap petugas.", "Nah, ketukan menyorot produk."],
  ...
  "ads-waktu-berhenti": {
    ...
    friction2: ["Nama produk didekatkan, sih.", "Kasir mengangkat tulisan, sih.", "Label putih diputar, sih.", "Kartu harga masuk, sih."],
    spikes: ["Nah, produk terlihat.", "Nah, kasirnya terbaca.", "Nah, label menghadap saksi.", "Nah, harga disorot."],
    questions: ["Pose aktor?", "Jarum jam?", "Papan kasir?", "Detik beku?"],
    saksi: "kasir yang membeku",
  },
  "kenalin-bisnis": {
    hooks: ["Nah, nama apa di kartu?", "Eh, siapa membuka lipatan?", "Bun, tulisan dalam amplop?", "Kirain halamannya kosong?"],
    friction1: ["Kartu meja dibuka.", "Lipatan informasinya dibentang.", "Amplop kertas diangkat.", "Halaman catatan dibuka."],
    friction2: ["Nama layanan didekatkan, sih.", "Kategorinya ditunjuk, sih.", "Tulisan kartu dibaca, sih.", "Nama bisnis ditulis, sih."],
    spikes: ["Nah, layanannya terlihat.", "Nah, kategorinya terbaca.", "Nah, bisnis menghadap saksi.", "Nah, halaman disorot."],
    questions: ["Judul layanan?", "Nama kategori?", "Identitas bisnis?", "Baris halaman?"],
    saksi: "teman kerja off camera",
  },
  "promo-terbatas": {
    hooks: ["Nah, angka di kartu?", "Eh, tulisan di label?", "Nah, kasir menunjuk angka?", "Yakin nama kartunya terbaca?"],
    friction1: ["Kartu harga dibuka.", "Label kuning diangkat.", "Kasir menunjuk angka.", "Nama produk didekatkan."],
    friction2: ["Nama kemasan diputar, sih.", "Angka pada label disorot, sih.", "Kartu produknya dibalik, sih.", "Tulisan harga diarahkan, sih."],
    spikes: ["Nah, nama-harganya terlihat.", "Angkanya terbaca.", "Harga menghadap saksi.", "Nah, tulisan disorot."],
