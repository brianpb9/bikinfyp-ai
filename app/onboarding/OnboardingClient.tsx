...
/**
 * KENAPA `brand` DATANG SEBAGAI PROP, BUKAN DIBACA DI SINI.
 *
 * Versi pertama membacanya di useEffect — dan itu berarti HTML yang DIKIRIM
 * SERVER tetap versi retail. Cat pertama yang dilihat calon brand tetap
 * berbunyi "Daftar gratis — 1 video demo", janji yang untuk mereka tidak benar,
 * lalu berganti sesudah JavaScript jalan. Kedipan itu bukan detail kosmetik:
 * kalimat yang salah sempat terbaca, dan pada koneksi lambat ia terbaca lama.
 * Sekarang server yang memutuskan, dari parameter DAN dari hostname.
 */
export default function OnboardingClient({ brand }: { brand: boolean }) {
