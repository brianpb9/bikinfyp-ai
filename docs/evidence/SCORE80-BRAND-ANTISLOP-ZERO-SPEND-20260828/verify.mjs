...
for (const path of ["lib/brand-antislop-evidence.mjs", "scripts/verify-brand-antislop-evidence.mjs", "tests/brand-antislop-evidence.test.mjs", "lib/media/qc-frame.ts"]) {
